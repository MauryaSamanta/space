...
This implementation uses vectorized numpy operations (meshgrid + trapezoid)
...
def chan_collision_probability(
    ...
    int_r = np.trapezoid(integrand, rs, axis=1)          # shape (n_theta,)
    integral = np.trapezoid(int_r, thetas)               # scalar
